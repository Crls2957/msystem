							...
							<table width="60%" border="0" style="background-image: url(../images/formbj3.jpg)">
								...
								<tr>
									...
									<td width="65%" align="left">
										<input name="eid" type="text" readonly="readonly" value="<%=emploe.getEid()%>" />
									</td>
								</tr>
								<tr>
									<td width="35%" align="right">
									...
									<td width="65%" align="left">
										<input name="ename" type="text" value="<%=emploe.getEname()%>" />
									</td>
								</tr>
								<tr>
									<td width="35%" align="right">
									...
									<td width="65%" align="left">
										<input name="esalary" type="text" value="<%=emploe.getEsalary()%>" />
									</td>
								</tr>
								<tr>
									<td width="35%" align="right">
								...
								<tr>
									...
									<td width="65%" align="left">
										<input name="ebir" type="text" value="<%=emploe.getEbir()%>" id="time" onclick="return Calendar('time')" />
									</td>
								</tr>
								<tr>
									<td width="35%" align="right">
								...
								<tr>
									...
									<td width="65%" align="left">
										<select name="eedu"  style="width: 156px" >
											<option value="<%=emploe.getEedu()%>" selected="selected">--<%=emploe.getEedu()%>--</option>
								...
								<tr>
									...
									<td width="65%" align="left">
										<select name="did" style="width: 156px" >
											...
											%>
											<option value="<%=dept.getDid()%>" ><%=dept.getDname()%></option>
												<%}%>
										</select>
									</td>
								</tr>
									...
									<td width="65%" align="left">
										<select name="pid"  style="width: 156px" >
											...
											<%
												...
												for(Post post:arrayList1){
											%>
											<option value="<%=post.getPid()%>" ><%=post.getPname()%></option>
											<%}%>
										</select>
									</td>
								</tr>
								<tr>
									...
									<td width="65%" align="left">
										<input name="ephone" type="text" value="<%=emploe.getEphone()%>" />
									</td>
								</tr>
								<tr>
									<td width="35%" align="right">
									...
									<td width="65%" align="left">
										<input name="eaddr" type="text" value="<%=emploe.getEaddr()%>" />
									</td>
								</tr>
