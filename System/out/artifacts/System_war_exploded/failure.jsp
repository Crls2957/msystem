...
<html>
	...
	<body bgcolor="#6CA6CD">
		<center>
			...
			%>
			<span class="STYLE1"> <br> <br> <br> <br><br> <br> <br> <br>添加成功</span>
			<%
			...
			%>
			<span class="STYLE1"> <br> <br> <br> <br><br> <br> <br> <br>添加失败</span>
			<%
			...
			%>
			<span class="STYLE1"> <br> <br> <br> <br><br> <br> <br> <br>修改成功</span>
			<%
			...
			%>
			<span class="STYLE1"> <br> <br> <br> <br><br> <br> <br> <br>删除失败</span>
			<%
