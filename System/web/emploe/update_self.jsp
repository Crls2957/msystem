...
<html>
	...
	<body bgcolor="#6CA6CD" onload="load()">
		<center>
						...
						<form action="../EmploeUpdateSelf" onSubmit="return emploe_validate()">
							<table width="60%" border="0" style="background-image: url(../images/formbj3.jpg)">
								...
								<tr>
									...
									<td width="65%" align="left">
										<input name="esalary" type="text" value="<%=emploe.getEsalary()%>"  readonly="readonly"/>
									</td>
								</tr>
								<tr>
									<td width="35%" align="right">
									...
									<td width="65%" align="left">
										<select name="did" style="width: 156px" >
											...
											<%
												...
												arrayList=(ArrayList<Dept>)request.getSession().getAttribute("dept");
								...
								<tr>
									...
									<td width="65%" align="left">
										<input name="equestion" type="text"  />
									</td>
								</tr>
								<tr>
									<td width="35%" align="right">
